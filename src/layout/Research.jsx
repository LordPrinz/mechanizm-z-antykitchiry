			...
			<div className={classes.container}>
				...
				<div className={`${classes["paragraph--1"]} u-margin-bottom-big`}>
					<Paragraph>
						...
						Numizmatycznego - Ioannisa Svoronosowa oraz filologa Adolpha
						Wilhelma z Austriackiego Instytutu Archeologicznego w Atenach.
				...
				<div className={`${classes["paragraph--2"]} u-margin-bottom-medium`}>
					<Paragraph>
						...
						międzyczasie eksponat został nieco oczyszczony, co pozwoliło
						badaczowi odczytać więcej napisów. Odszyfrował m.in. nazwę jednego z
				...
				<div className={`${classes["paragraph--3"]} u-margin-bottom-big`}>
					<Paragraph>
						...
						Price analizował fragmenty mechanizmu pod mikroskopem. <br /> Z
						...
						słowo Chelai, czyli szczypce - tak starożytni Grecy nazywali
						ówczesną konstelację Wagi. Z kolei po lewej stronie tarczy
						odszyfrował dwuliterowy fragment "no", który uznał za część słowa
						Parthenos, czyli konstelację Panny. W ten sposób udało się
						potwierdzić przypuszczenie wcześniejszych badaczy, że urządzenie
						pokazywało znaki zodiaku i związane z nimi konstelacje. <br />
						Na zewnętrznej części tarczy zaznaczono 12 miesięcy, liczących po 30
						dni, z 365-dniowego roku. Wskazówka na wewnętrznej tarczy pokazywała
						drogę Słońca na tle gwiazd, a zewnętrzna skala podawała aktualną
						datę. Różnicę wynikającą z czasu obrotu Ziemi dookoła Słońca
						wynoszącą 365 i jedną czwartą dnia można było usunąć ręcznie
						przestawiając tarczę co cztery lata. Z kolei z tyłu urządzenia
						znajdowały się dwie tarcze, ułożone jedna na drugiej, podzielone na
						segmenty liczące około 6 stopni i pokryte inskrypcjami. <br />
						Solla Price i Stamires uznali, że pokazywały one cykliczne zmiany
						położenia Księżyca i Słońca.
					</Paragraph>
				</div>
				...
				<div className={`${classes["paragraph--5"]} u-margin-bottom-big`}>
					<Paragraph>
						...
						wykonali zdjęcia rentgenowskie oraz przeprowadzili jego tomografię.
						Ich zdaniem urządzenie służyło do odtwarzania ruchu Merkurego,
						Wenus, Marsa, Jowisza i Saturna. Mechanizm wskazywał też lata, na
						które przypadały igrzyska olimpijskie. W 2000 roku kolejne pokolenie
						badaczy wyposażone w jeszcze nowszy sprzęt przeprowadziła inne
						badania. Grupa amerykańskich naukowców i techników pod kierunkiem
						matematyka Tony'ego Freetha stworzyła specjalne urządzenie
						pozwalające wykonać bardzo dokładne zdjęcia rentgenowskie obiektu, a
						następnie sporządzić jego obraz 3D. Każdą część uwieczniono na około
						3 tysiącach zdjęć, odczytano ponad 2 tysiące znaków, w tym terminy
						mechaniczne, policzono raz jeszcze liczbę zębów przy kołach.
						<br />
						Na podstawie wykonanych badań, naukowcy doszli do wniosku, że
						mechanizm z Antykithiry służył także do wyliczania czasów zaćmień
						Słońca i Księżyca. <br /> Bardzo dokładny model urządzenia
